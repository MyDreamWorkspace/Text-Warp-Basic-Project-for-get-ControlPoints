// import Canvg, {elements} from "canvg";
...
const saveResult = (btn, content) => {
  btn.onclick = () => {
    var svgContent = new XMLSerializer().serializeToString(content)
    console.log("content", svgContent);
    var fileName = "warp_text.png";
    SVGToImage({svg: content, mimetype:"image/png", width:"auto", height:"auto", quality: 1, outputFormat: "base64"})

...
var drawSvgPath = function(shape, rows)
{
  ...
  {
    startPoints.push((i * z1 / rows) + getRandomInt(-50, 50));
  }
  startPoints.push(z1);

  for (var i = 1; i <  rows; i ++)
  {
    endPoints.push((z3 - i * (z3 - z2) / rows) + getRandomInt(-50, 50));
  }
  endPoints.push(z2);
  ...
  for (var i = 0; i < rows; i ++)
  {
    ...
    p1.x += getRandomInt(-100, 100);
    p1.y += getRandomInt(-100, 100);
    p2.x += getRandomInt(-100, 100);
    p2.y += getRandomInt(-100, 100);
    rects[i].t1 = p1;
    rects[i].t2 = p2;
    if (i == 0)
    {
      ...
      p1.x += getRandomInt(-50, 50);
      p1.y += getRandomInt(-50, 50);
      p2.x += getRandomInt(-50, 50);
      p2.y += getRandomInt(-50, 50);
      rects[i].b1 = p1;
      rects[i].b2 = p2;
    }
    else
  ...
  for (var i = rects.length - 1; i >= 0; i --)
  {
    ...
    for (var j = real_lt; j >= rects[i].lb; j -= interval)
    {
